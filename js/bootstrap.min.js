...
jQuery(document).ready(function(a){a(".comment-reply-link").addClass("btn btn-primary");a("#submit").addClass("btn btn-primary");a("a.kibble-like_btn").click(function(){response_div=a(this).parent().parent();a.ajax({url:VOTING.base_url,data:{"kibble-vote_like":a(this).attr("post_id")},beforeSend:function(){},success:function(b){response_div.html(b).fadeIn(900)},complete:function(){}})});a("a.kibble-dislike_btn").click(function(){response_div=a(this).parent().parent();a.ajax({url:VOTING.base_url,data:{"kibble-vote_dislike":a(this).attr("post_id")},beforeSend:function(){},success:function(b){response_div.html(b).fadeIn(900)},complete:function(){}})})});
